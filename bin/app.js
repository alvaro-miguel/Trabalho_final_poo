...
class App {
    ...
    cadastrarPersonagem() {
        ...
        console.log("Classes: 1-Guerreiro, 2-Mago, 3-Arqueiro, 4-Vampiro");
        const opcao = input("Opção: ");
        const vida = Number(input("Vida (100): ") || 100);
        ...
        try {
            switch (opcao) {
                case "1":
                    p = new Guerreiro(id, nome, vida, ataque, Number(input("Defesa: ")));
                    break;
                case "2":
                    p = new Mago(id, nome, vida, ataque);
                    break;
                case "3":
                    p = new Arqueiro(id, nome, vida, ataque, Number(input("Multiplicador (2): ") || 2));
                    break;
                case "4":
    ...
    listarPersonagens() {
        ...
        if (todos.length === 0)
            return console.log("Ninguém na arena.");
    ...
    realizarTurnoManual() {
        ...
        if (vivos.length < 2)
            return console.log("⚠️ Precisa de 2 vivos para lutar.");
        console.log("\n--- ⚔️  TURNO MANUAL ⚔️  ---");
    ...
    async modoSimulacao() {
        ...
        if (vivos.length < 2)
            return console.log("⚠️ Precisa de mais gente para simular.");
    ...
    async replayBatalha() {
        ...
        if (logs.length === 0)
            return console.log("Nada para assistir.");
        console.log("\n🎬 --- REPLAY DA BATALHA --- 🎬");
